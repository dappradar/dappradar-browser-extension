    ...
    if (!stats && loading) {
        return (
            <div className="flex flex-col place-content-center py-16">
                <h3 className="text-accent text-center"> 🔎 Looking for data</h3>
                <Loader />
            </div>
        )
    }
    ...
    return (
        <div>
            ...
            {apiConnected && <div className="container px-2">
                            <DappStats appURL={appURL} apiKey={apiKey} />
                        </div>
            }
...
const Stats = ({stats, name, categories}) => (
    <div>
        ...
        <div className="alert alert-warning shadow-lg mt-1">
            <div>
...
const Onboarding = () => (
    <div className="flex py-2 place-content-center">
       Set up your extension with the DappRadar API Key <br/>
        Go to <a onClick={() => chrome.runtime.openOptionsPage()}>Settings</a>
    </div>
);
